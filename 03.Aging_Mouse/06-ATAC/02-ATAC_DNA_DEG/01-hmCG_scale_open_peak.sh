...
# Usage: bash ./01-hmCG_scale_open_peak.sh <bed_filename> <bw_filename> <age>
...
bw_file="${indir}/${age}/5hmC/${bw_filename}/CG/merge_bw/subclass.${bw_filename}_${age}_5hmC.Merge.allc.tsv.gz.CG.bw"
outdir="${your_outdir}/01_hmCG_open_peak/"
...
#SBATCH -o ${your_outdir}/logs/01-${bed_filename}_${bw_filename}_${age}_5hmCG.scale.log
#SBATCH -e ${your_outdir}/logs/01-${bed_filename}_${bw_filename}_${age}_5hmCG.scale.log
