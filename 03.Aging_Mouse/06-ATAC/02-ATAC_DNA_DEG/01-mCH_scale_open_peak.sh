...
# Usage: bash ./01-mCH_scale_open_peak.sh <bed_filename> <bw_filename> <age>
...
bw_file="${indir}/${age}/5mC/${bw_filename}/CH/merge_bw/subclass.${bw_filename}_${age}_5mC.Merge.allc.tsv.gz.CH.bw"
outdir="${your_outdir}/01_mCH_open_peak/"
...
#SBATCH -o ${your_outdir}/logs/01-${bed_filename}_${bw_filename}_${age}_5mCH.scale.log
#SBATCH -e ${your_outdir}/logs/01-${bed_filename}_${bw_filename}_${age}_5mCH.scale.log
...
echo "Output file: ${outdir}/${subclass}_${age}_5mCH.mm10.gz"
...
computeMatrix scale-regions \
      ...
      -o ${outdir}/${subclass}_${age}_5mCH.mm10.gz

if [ \$? -eq 0 ]; then
  echo "computeMatrix completed successfully."

  touch ${outdir}/${subclass}_${age}_5mCH.mm10.tmp

  echo "Running R script for subclass: ${subclass}"
  echo "Rscript input: ${outdir}/${subclass}_${age}_5mCH.mm10.gz"
  echo "Rscript output: ${outdir}/${subclass}_${age}_5mCH.mm10.tmp"

  Rscript ./01-process_getMean.R \
  ${outdir}/${subclass}_${age}_5mCH.mm10.gz \
  ${outdir}/${subclass}_${age}_5mCH.mm10.tmp 
