...
write.csv(total_mC.diff_matrix.sorted,file = "../../output/03.Aging_Mouse/DMRs_DHMRs/subclass_specific_top_DMRs_DHMRs_heatmap/hyper_DHMR.5hmCG_mean_diff_old_minus_young_matrix.subclass_specific_top_500.csv",quote=F,row.names=T,col.names=T)
...
write.csv(total_mC.diff_matrix.sorted,file = "../../output/03.Aging_Mouse/03-DMRs_DHMRs/subclass_specific_top_DMRs_DHMRs_heatmap/hyper_DHMR.5mCG_5hmCG_mean_diff_old_minus_young_matrix.subclass_specific_top_500.csv",quote=F,row.names=T,col.names=T)
...
total_mC.diff_matrix = total_mC.diff_matrix[,-1]
total_mC.diff_matrix.sorted = total_mC.diff_matrix[row_order,col_order]
write.csv(total_mC.diff_matrix.sorted,file = "../../output/03.Aging_Mouse/03-DMRs_DHMRs/subclass_specific_top_DMRs_DHMRs_heatmap/hyper_DHMR.5mCG_mean_diff_old_minus_young_matrix.subclass_specific_top_500.csv",quote=F,row.names=T,col.names=T)

## plot 5mCG mean diff value heatmap ##
merge.df.dcast.temp = fread("../../output/03.Aging_Mouse/03-DMRs_DHMRs/subclass_specific_top_DMRs_DHMRs_heatmap/hyper_DHMR.5mCG_mean_diff_old_minus_young_matrix.subclass_specific_top_1000.csv",data.table=F,header=T)
...
png(filename = "../../output/03.Aging_Mouse/03-DMRs_DHMRs/subclass_specific_top_DMRs_DHMRs_heatmap/aging_hyper_DHMRs_top1000.true_5mCG_diff_old_minus_young.heatmap.png", width = 8.2677, height = 21.2598, units = "cm", res = 300)
...
merge.df.dcast.temp = fread("../../output/03.Aging_Mouse/03-DMRs_DHMRs/subclass_specific_top_DMRs_DHMRs_heatmap/hyper_DHMR.5mCG_5hmCG_mean_diff_old_minus_young_matrix.subclass_specific_top_1000.csv",data.table=F,header=T)
rownames(merge.df.dcast.temp) = merge.df.dcast.temp[,1]
merge.df.dcast.temp  = merge.df.dcast.temp[,-1]
total_mC.diff_matrix = as.matrix(merge.df.dcast.temp)
ha1=HeatmapAnnotation(subclass = colnames(total_mC.diff_matrix),show_legend = FALSE,annotation_name_side = "right",col = list(subclass=inte.col),annotation_legend_param = list(direction = "horizontal", title_position = "topleft",fontsize = 20))

png(filename = "../../output/03.Aging_Mouse/03-DMRs_DHMRs/subclass_specific_top_DMRs_DHMRs_heatmap/aging_hyper_DHMRs_top1000.5mCG_5hmCG_diff_old_minus_young.heatmap.png", width = 8.2677, height = 21.2598, units = "cm", res = 300)
col_fun =colorRamp2(c(-0.2,-0.1,0,0.1,0.2), c("dodgerblue4", "deepskyblue","grey85", "darkorange", "firebrick3")) 
Heatmap(total_mC.diff_matrix,
        column_gap = unit(0, "points"),
        bottom_annotation = ha1,
...
merge.df.dcast.temp = fread("../../output/03.Aging_Mouse/03-DMRs_DHMRs/subclass_specific_top_DMRs_DHMRs_heatmap/hyper_DHMR.5hmCG_mean_diff_old_minus_young_matrix.subclass_specific_top_1000.csv",data.table=F,header=T)
rownames(merge.df.dcast.temp) = merge.df.dcast.temp[,1]
merge.df.dcast.temp  = merge.df.dcast.temp[,-1]
total_mC.diff_matrix = as.matrix(merge.df.dcast.temp)
ha1=HeatmapAnnotation(subclass = colnames(total_mC.diff_matrix),show_legend = FALSE,annotation_name_side = "right",col = list(subclass=inte.col),annotation_legend_param = list(direction = "horizontal", title_position = "topleft",fontsize = 20))

png(filename = "../../output/03.Aging_Mouse/03-DMRs_DHMRs/subclass_specific_top_DMRs_DHMRs_heatmap/aging_hyper_DHMRs_top1000.5hmCG_diff_old_minus_young.heatmap.png", width = 8.2677, height = 21.2598, units = "cm", res = 300)
col_fun =colorRamp2(c(-0.2,-0.1,0,0.1,0.2), c("dodgerblue4", "deepskyblue","grey85", "darkorange", "firebrick3")) 
Heatmap(total_mC.diff_matrix,
        column_gap = unit(0, "points"),
        bottom_annotation = ha1,
...
pdf("../../output/03.Aging_Mouse/03-DMRs_DHMRs/subclass_specific_top_DMRs_DHMRs_heatmap/heatmap_legend.max_0.2.pdf",width=8.2677,height=21.2598)
col_fun =colorRamp2(c(-0.2,-0.1,0,0.1,0.2), c("dodgerblue4", "deepskyblue","grey85", "darkorange", "firebrick3"))
Heatmap(total_mC.diff_matrix,
        column_gap = unit(0, "points"),
        bottom_annotation = ha1,
