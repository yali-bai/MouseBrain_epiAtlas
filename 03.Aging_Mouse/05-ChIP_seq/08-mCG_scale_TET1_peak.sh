...
# Usage: bash ./08-mCG_scale_TET1_peak.sh <bw_filename> <age>
...
outdir="${your_outdir}/08_mCG_TET1_peak"

bw_file="${indir}/${age}/02_allc_to_bw/subclass/5mC/CG/${bw_filename}.CGN-both.frac.bw"
...
#SBATCH -o ${your_outdir}/logs/08-${bw_filename}_${age}_5mCG.scale.log
#SBATCH -e ${your_outdir}/logs/08-${bw_filename}_${age}_5mCG.scale.log
