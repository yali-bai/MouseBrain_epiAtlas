...
# Usage: bash ./08-true5mCG_scale_TET1_peak.sh <bw_filename> <age>
...
outdir="${your_outdir}/08_true5mCG_TET1_peak"

bw_file="${indir}/${age}/02_allc_to_bw/subclass/true5mC/CG/${bw_filename}.CGN-both.frac.bw"
...
#SBATCH -o ${your_outdir}/logs/08-${bw_filename}_${age}_true5mCG.scale.log
#SBATCH -e ${your_outdir}/logs/08-${bw_filename}_${age}_true5mCG.scale.log
