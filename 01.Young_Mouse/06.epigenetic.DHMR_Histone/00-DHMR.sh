...
## 01-DHMR states
DMR_state = ad.read_h5ad("../04.subclass.DMR/03-stratified_RankSumTest_1vsOthers/01_subclasses_in_neuron_1vsOthers/5hmCG_DMR_states_neuron_1vsOthers.h5ad")
...
state_counts_transposed.to_csv('./03_Histone/Paired-Tag_DMR/output/00-dhmr_state_collapsed_matrix_neuron.csv')
...
result_df.to_csv('./03_Histone/Paired-Tag_DMR/output/00-dhmr_hyper_hypo_subclass_number_neuron.csv')


## 02-specific_hyper_hypo_DHMR_statistics
import pandas as pd

df = pd.read_csv('./03_Histone/Paired-Tag_DMR/output/00-dhmr_state_collapsed_matrix_neuron.csv', index_col=0)
...
specific_stats_df.to_csv('./03_Histone/Paired-Tag_DMR/output/00-dhmr_specific_stats_df.csv')
...
longest_region_df.to_csv('./03_Histone/Paired-Tag_DMR/output/00-DHMR_in_genebody_paired.csv')
...
specific_stats_df.to_csv('./03_Histone/Paired-Tag_DMR/output/00-dhmr_specific_hyper_hypo_DHMR_include_region.csv')
...
Hyper_hypo_stats_df.to_csv('./03_Histone/Paired-Tag_DMR/output/00-dhmr_hyper_hypo_DHMR_include_region.csv')
