...
# Usage: bash ./07-H3K27me3_scale_Allsubclass.sh <bed_filename> <bw_filename> <outdir_suffix>
...
bed_dir="../03_Histone/Paired-Tag_DMR/output/02_DHMR_hyper_bed/"
bw_dir="../analysis/Histone/Paired-Tag_DMR_latest/output/01_bw/"
base_outdir="./03_Histone/Paired-Tag_DMR/output/07_H3K27me3_Allsubclass/"
...
sbatch <<RUN
#!/usr/bin/bash
#SBATCH -J scale_${subclass}_H3K27me3
#SBATCH --mem=30G
#SBATCH --cpus-per-task=10
#SBATCH --partition=compute_pro
#SBATCH -o ./logs/07-${subclass}_H3K27me3.scale.log
#SBATCH -e ./logs/07-${subclass}_H3K27me3.scale.log
