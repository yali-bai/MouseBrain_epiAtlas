...
# Usage: bash ./05-H3K9me3_scale_Allsubclass.sh <bed_filename> <bw_filename> <outdir_suffix>
...
base_outdir="./03_Histone/Paired-Tag_DMR/output/05_H3K9me3_Allsubclass/"
...
sbatch <<RUN
#!/usr/bin/bash
#SBATCH -J scale_${subclass}_H3K9me3
#SBATCH --mem=30G
#SBATCH --cpus-per-task=10
#SBATCH --partition=compute_fat
#SBATCH -o ./logs/05-${subclass}_H3K9me3.scale.log
#SBATCH -e ./logs/05-${subclass}_H3K9me3.scale.log
