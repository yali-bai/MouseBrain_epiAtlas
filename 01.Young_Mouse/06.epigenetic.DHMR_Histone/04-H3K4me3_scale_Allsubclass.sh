...
# Usage: bash ./04-H3K4me3_scale_Allsubclass.sh <bed_filename> <bw_filename> <outdir_suffix>
...
base_outdir="./03_Histone/Paired-Tag_DMR/output/04_H3K4me3_Allsubclass/"
...
sbatch <<RUN
#!/usr/bin/bash
#SBATCH -J scale_${subclass}_H3K4me3
#SBATCH --mem=30G
#SBATCH --cpus-per-task=10
#SBATCH --partition=compute_pro
#SBATCH -o ./logs/04-${subclass}_H3K4me3.scale.log
#SBATCH -e ./logs/04-${subclass}_H3K4me3.scale.log
