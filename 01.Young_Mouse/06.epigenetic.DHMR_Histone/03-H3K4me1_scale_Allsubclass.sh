...
# Usage: bash ./03-H3K4me1_scale_Allsubclass.sh <bed_filename> <bw_filename> <outdir_suffix>
...
bw_dir="../Histone/Paired-Tag_DMR_latest/output/01_bw/"
base_outdir="./03_Histone/Paired-Tag_DMR/output/03_H3K4me1_Allsubclass/"
...
sbatch <<RUN
#!/usr/bin/bash
#SBATCH -J scale_${subclass}_H3K4me1
#SBATCH --mem=30G
#SBATCH --cpus-per-task=10
#SBATCH --partition=compute_pro
#SBATCH -o ./logs/03-${subclass}_H3K4me1.scale.log
#SBATCH -e ./logs/03-${subclass}_H3K4me1.scale.log
