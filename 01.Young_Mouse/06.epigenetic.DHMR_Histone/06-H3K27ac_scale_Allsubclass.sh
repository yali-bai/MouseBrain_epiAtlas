...
base_outdir="./03_Histone/Paired-Tag_DMR/output/06_H3K27ac_Allsubclass/"
...
#SBATCH -o ./logs/06-${subclass}_H3K27ac.scale.log
#SBATCH -e ./logs/06-${subclass}_H3K27ac.scale.log
