...
for modification in ["5mC", "5hmC"]:
    for chr_number in range(1, 20, 1):
        ...
        subprocess.run(f"sbatch -J ThreeClass_RankSumTest_{modification}_chr{chr_number}_1vsOthers \
        -o ./logs/ThreeClass_RankSumTest_{modification}_chr{chr_number}_1vsOthers.log \
        -e ./logs/ThreeClass_RankSumTest_{modification}_chr{chr_number}_1vsOthers.log \
        --mem={"400G" if chr_number<10 else "250G"} \
