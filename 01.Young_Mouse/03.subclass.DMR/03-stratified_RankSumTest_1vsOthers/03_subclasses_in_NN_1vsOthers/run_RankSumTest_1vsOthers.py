...
for modification in ["5mC", "5hmC"]:
    for chr_number in range(1, 20, 1):
        ...
        subprocess.run(f"sbatch -J NN_RankSumTest_{modification}_chr{chr_number}_1vsOthers \
        -o ./logs/NN_RankSumTest_{modification}_chr{chr_number}_1vsOthers.log \
        -e ./logs/NN_RankSumTest_{modification}_chr{chr_number}_1vsOthers.log \
