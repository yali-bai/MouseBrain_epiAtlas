...
for subclass_liu in df['subclass_liu']:
    ...
    mcool_file = f'./{subclass_liu}.Q.100K.mcool'
    ...
    mcool2h5 = subprocess.run([
        ...
        '--inputFormat', 'cool', 
        '--outputFormat', 'h5', 
        '--outFileName', f'./01_3C/output/h5/{subclass_liu}_100K.h5'
    ...
    h5_hicPCA = subprocess.run([
        'hicPCA',
        '--matrix', f'./01_3C/output/h5/{subclass_liu}_100K.h5',
        '--outputFileName', 
        f'./01_3C/output/h5/{subclass_liu}_100K_PCA_PC1.bedgraph',
        f'./01_3C/output/h5/{subclass_liu}_100K_PCA_PC2.bedgraph',
        f'./01_3C/output/h5/{subclass_liu}_100K_PCA_PC3.bedgraph',
        '--format', 'bedgraph',
    ...
    pca1_results = pd.read_csv(f'./01_3C/output/h5/{subclass_liu}_100K_PCA_PC1.bedgraph', sep='\t', header=None)
    ...
    output_path = f'./01_3C/output/h5/{subclass_liu}_100K_compartments.tsv'
