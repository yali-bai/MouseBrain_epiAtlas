...
pdf(paste0("../../../output/01.Young_Mouse/01-methylation_line_graph/hmCG_group3_turn.pdf"),height = 10,width = 16)
plot_grid(plotlist = plots[1:30], ncol = 6)
dev.off()
pdf(paste0("../../../output/01.Young_Mouse/01-methylation_line_graph/hmCH_group3_turn.pdf"),height = 10,width = 16)
plot_grid(plotlist = plots[31:60], ncol = 6)
dev.off()
pdf(paste0("../../../output/01.Young_Mouse/01-methylation_line_graph/mCG+hmCG_group3_turn.pdf"),height = 10,width = 16)
plot_grid(plotlist = plots[61:90], ncol = 6)
dev.off()
pdf(paste0("../../../output/01.Young_Mouse/01-methylation_line_graph/mCH+hmCH_group3_turn.pdf"),height = 10,width = 16)
plot_grid(plotlist = plots[91:120], ncol = 6)
dev.off()
pdf(paste0("../../../output/01.Young_Mouse/01-methylation_line_graph/hmCG_mCG+hmCG_group3_turn.pdf"),height = 10,width = 16)
plot_grid(plotlist = plots[121:150], ncol = 6)
dev.off()
pdf(paste0("../../../output/01.Young_Mouse/01-methylation_line_graph/mCG_group3_turn.pdf"),height = 10,width = 16)
plot_grid(plotlist = plots[151:180], ncol = 6)
dev.off()
pdf(paste0("../../../output/01.Young_Mouse/01-methylation_line_graph/mCH_group3_turn.pdf"),height = 10,width = 16)
