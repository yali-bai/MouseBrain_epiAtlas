...
bw_dir="${indir}/01_bw/"
base_outdir="${your_outdir}/04_H3K4me3_Allsubclass/"
...
#SBATCH -o ${your_outdir}/logs/04-${subclass}_H3K4me3.scale.log
#SBATCH -e ${your_outdir}/logs/04-${subclass}_H3K4me3.scale.log
