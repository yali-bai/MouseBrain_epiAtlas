...
bw_dir="${indir}t/01_bw/"
base_outdir="${your_outdit}/03_H3K4me1_Allsubclass/"
...
#SBATCH -o ${your_outdir}/logs/03-${subclass}_H3K4me1.scale.log
#SBATCH -e ${your_outdir}/logs/03-${subclass}_H3K4me1.scale.log
