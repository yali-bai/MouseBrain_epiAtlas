...
bw_dir="${indir}/01_bw/"
base_outdir="${your_outdir}/05_H3K9me3_Allsubclass/"
...
#SBATCH -o ${your_outdir}/logs/05-${subclass}_H3K9me3.scale.log
#SBATCH -e ${your_outdir}/logs/05-${subclass}_H3K9me3.scale.log
