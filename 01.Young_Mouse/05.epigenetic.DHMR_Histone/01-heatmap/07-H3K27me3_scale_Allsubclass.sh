...
bw_dir="${indir}/01_bw/"
base_outdir="${your_outdir}/07_H3K27me3_Allsubclass/"
...
#SBATCH -o ${your_outdir}/logs/07-${subclass}_H3K27me3.scale.log
#SBATCH -e ${your_outdir}/logs/07-${subclass}_H3K27me3.scale.log
