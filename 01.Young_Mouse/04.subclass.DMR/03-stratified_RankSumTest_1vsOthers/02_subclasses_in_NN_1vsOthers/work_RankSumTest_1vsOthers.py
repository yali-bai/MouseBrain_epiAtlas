...
indir="../../02-generate_segment_MCDS"
outdir="./result"
...
data=anndata.read_h5ad(f"{indir}/{modification2}G_frac_segment_by_cell_chr{chr_number}.h5ad").to_df()
...
meta_data3=meta_data2[["subclass_label", modification2+'_SampleID']]
...
data_dict={subclass_ : data.loc[allc_name(meta_data_group.get_group(subclass_)[modification2+'_SampleID'])] for subclass_ in subclass_list}
