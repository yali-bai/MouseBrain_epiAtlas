...
## rds ##
zhuang.obj <- readRDS("Zhuang_raw_counts.rds")
# downloaded from https://datasets.cellxgene.cziscience.com/f9f6cc29-7d06-47be-a798-e4e3b36a86b2.rds

## annotation ##
anno.df <- read.csv("../03.data/03.download_data/cell_metadata_Zhuang_MERFISH.csv",colClasses = c("character","character","character","character","character","character","character","numeric","numeric","numeric","numeric","numeric","character"))
...
saveRDS(seurat_subset_region,file="./subset.z_axis_located_on_7.33.cortex_and_hippo.rds")
